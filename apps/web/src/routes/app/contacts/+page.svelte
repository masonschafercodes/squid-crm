    ...
    <div class="flex gap-3 h-full mt-4 relative overflow-hidden">
        ...
        >
            ...
            >
                ...
                >
                    <span class="text-sm text-zinc-700/90">Download</span>
            ...
            >
                ...
                <button class="p-3 flex flex-col gap-1 hover:bg-zinc-100/40">
                    <span class="text-sm text-zinc-700/80 font-semibold"
                        >Sort</span
                    >
                    <span class="text-sm text-zinc-700/60"
                        >First name (A-Z)</span
                    >
                </button>
                <button class="p-3 flex flex-col gap-1 hover:bg-zinc-100/40">
                ...
                <button
                    class="p-3 flex items-center justify-between hover:bg-zinc-100/40"
                >
                    <span class="text-sm text-zinc-700/80">Add a filter</span>
                ...
                {#if $contacts}
                    {#each $contacts as contact}
                        <div class="w-full flex items-center px-3 py-5 gap-6">
                            ...
                            <div
                                class="flex flex-col gap-1 w-1/2 lg:w-1/3 2xl:w-1/4"
                            >
                                ...
                                {#if contact.workPhone}
                                    <div class="flex items-center gap-2">
                                        ...
                                        <span
                                            class="text-zinc-700 text-sm whitespace-nowrap"
                                        >
                                            {contact.workPhone}
                                        </span>
                                    </div>
