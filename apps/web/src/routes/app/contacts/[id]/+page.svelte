<script lang="ts">
  ...
  async function updateTaskStatus(taskId: string, status: "DONE" | "PENDING") {
    try {
      const newContactData = await fetcher<Contact>(
      ...
      <div class="w-[15%] h-full overflow-hidden hidden xl:flex flex-col gap-3">
        ...
        >
          ...
          <button
            class="p-3 flex items-center justify-between hover:bg-zinc-100/40"
          >
            <span class="text-sm text-zinc-700/90 font-semibold">Delete</span>
          ...
          <div class="flex flex-col gap-8 w-full">
            <div class="flex flex-col gap-1">
              <div class="flex items-center justify-between">
                ...
                <ButtonDropdown showDrowdown={dropdownOpen} w="w-[200px]">
                  <DropdownIcon
                    ...
                    slot="icon"
                  />
                  <span slot="button_text">Attach an Item</span>
                  <div
                  ...
                  >
                    ...
                    >
                      <span class="text-sm text-zinc-700/90 font-semibold"
                        >Task</span
                      >
                      <TasksIcon class="w-4 h-4 text-zinc-700/60" />
                    </button>
                    <button
                      class="p-3 flex items-center justify-between hover:bg-zinc-100/40"
                      on:click={() => {
                    ...
                    >
                      <span class="text-sm text-zinc-700/90 font-semibold"
                        >Group</span
                      >
                      <BookmarkIcon class="w-4 h-4 text-zinc-700/60" />
                    </button>
                  </div>
                </ButtonDropdown>
              </div>
              ...
              >
                <div class="p-3 flex items-start gap-4">
                  ...
                  >
                    <CheckIcon class="w-4 h-4 text-teal-800" />
                  </div>
                  <div class="flex flex-col gap-2 w-full mt-1.5">
                    <span
                      class="text-sm text-zinc-700 font-semibold whitespace-nowrap"
                    >
                      Upcoming Tasks ({$selectedContact.tasks.length})
                    </span>
                    {#each $selectedContact.tasks as task}
                      <div
                      ...
                      >
                        ...
                        <div class="flex flex-col gap-2">
                          <span
                            class="text-sm font-semibold {task.status === 'DONE'
                ...
                <div class="p-3 flex items-start gap-4">
                  ...
                  >
                    <BookmarkIcon class="w-4 h-4 text-orange-800" />
                  </div>
                  <div class="flex flex-col gap-2 w-full mt-1.5">
                    <span
                      class="text-sm text-zinc-700 font-semibold whitespace-nowrap"
                    >
                      Groups ({$selectedContact.groups.length})
                    </span>
            ...
            <div class="flex flex-col gap-1">
              ...
              <div
                class="bg-white border border-zinc-400/20 shadow-sm rounded-lg flex flex-col divide-y-[1px] divide-zinc-400/20"
              >
                <form class="p-3 relative" on:submit|preventDefault={addNote}>
                  <textarea
                        ...
                        <div class="flex flex-col gap-2 p-3">
                          ...
                          <div class="flex items-center justify-between gap-3">
                            <div
                              class="w-8 h-8 bg-orange-500/20 rounded-full flex items-center justify-center p-1"
                            >
                              <PlusIcon class="w-4 h-4 text-orange-800" />
                            </div>
                            <span class="text-sm text-zinc-700/70 flex-1">
                              {$selectedContact.firstName} was added to the CRM
                            </span>
                            <span class="text-sm text-zinc-700/70">
                      ...
                      {:else if event.type === "UPDATED"}
                        <div class="flex flex-col gap-2 p-3">
                          ...
                          <div class="flex items-center justify-between gap-3">
                            ...
                            >
                              <UpdateIcon class="w-4 h-4 text-green-800" />
                            </div>
                            <span class="text-sm text-zinc-700/70 flex-1">
                              {$selectedContact.firstName} was updated
                            </span>
                            <span class="text-sm text-zinc-700/70">
                              {new Date(event.createdAt).toLocaleTimeString()}
                            </span>
                      ...
                      {:else if event.type === "NOTE"}
                        <div class="flex flex-col gap-2 p-3">
                          ...
                          <div class="flex items-start justify-between gap-3">
                            ...
                            >
                              <NoteIcon class="w-4 h-4 text-blue-800" />
                            </div>
                            <div class="flex flex-col gap-2 flex-1">
                              <span class="text-sm text-zinc-700/70 flex-1">
                                A note was added to {$selectedContact.firstName}
                              </span>
                              <div
                      ...
                      {:else if event.type === "TASK_UPDATED"}
                        <div class="flex flex-col gap-2 p-3">
                          ...
                          <div class="flex items-start justify-between gap-3">
                            ...
                            <div class="flex flex-col gap-2 flex-1">
                              <span class="text-sm text-zinc-700/70 flex-1">
                                A task was updated for {$selectedContact.firstName}
                              </span>
                              <div
                                class="p-3 bg-zinc-50 border border-zinc-300/30 rounded-lg text-sm shadow-sm text-zinc-800/80"
                              >
                      ...
                      {:else if event.type === "TASK_CREATED"}
                        <div class="flex flex-col gap-2 p-3">
                          ...
                          <div class="flex items-center justify-between gap-3">
                            ...
                            >
                              <TasksIcon class="w-4 h-4 text-amber-800" />
                            </div>
                            <span class="text-sm text-zinc-700/70 flex-1">
                              A new task was created for {$selectedContact.firstName}
                            </span>
                            <span class="text-sm text-zinc-700/70">
                              {new Date(event.createdAt).toLocaleTimeString()}
                            </span>
                        ...
                        <div class="flex flex-col gap-2 p-3">
                          ...
                          <div class="flex items-start justify-between gap-3">
                            <div
                              class="w-8 h-8 bg-amber-500/20 rounded-full flex items-center justify-center p-1"
                            >
                              <BookmarkIcon class="w-4 h-4 text-amber-800" />
                            </div>
                            <div class="flex flex-col gap-2 flex-1">
                              <span class="text-sm text-zinc-700/70 flex-1">
                                Groups were added to {$selectedContact.firstName}
                              </span>
                              <div
                                class="p-3 bg-zinc-50 border border-zinc-300/30 rounded-lg text-sm shadow-sm text-zinc-800/80"
                              >
                      ...
                      {:else if event.type === "GROUP_REMOVED"}
                        <div class="flex flex-col gap-2 p-3">
                          ...
                          <div class="flex items-start justify-between gap-3">
                            ...
                            <div class="flex flex-col gap-2 flex-1">
                              <span class="text-sm text-zinc-700/70 flex-1">
                                A group was removed from {$selectedContact.firstName}
                              </span>
                              <div
                                class="p-3 bg-zinc-50 border border-zinc-300/30 rounded-lg text-sm shadow-sm text-zinc-800/80"
                              >
          ...
          <div class="flex flex-col gap-1 w-1/2">
            ...
            >
              ...
              <ContactInfoDetail
                ...
                value={$selectedContact?.personalAddress || "N/A"}
              />
              <ContactInfoDetail
                label="Work Address"
              ...
              <ContactInfoDetail
                ...
                value={$selectedContact?.backgroundInfo || "N/A"}
              />
            </div>
          </div>
        </div>
