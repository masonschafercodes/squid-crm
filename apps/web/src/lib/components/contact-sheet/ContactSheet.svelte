        ...
        <form class="grid gap-4" on:submit|preventDefault={handleCreateContact}>
            ...
            <div class="grid grid-cols-2 gap-2">
                <div class="flex flex-col gap-1">
                    ...
                    >
                        First Name
                        <span class="text-xs text-red-800 mr-2">
                            Required
                        </span>
                    </label>
                ...
                <div class="flex flex-col gap-1">
                    <label
                        for="contact-salutation"
                        class="text-sm text-zinc-700/70">Salutation</label
                    >
                    <div class="relative rounded-lg shadow-sm w-full">
                        <div
                            class="pointer-events-none absolute inset-y-0 left-0 flex items-center pl-3"
                ...
                <div class="flex flex-col gap-1 col-span-2">
                    <label
                        for="contact-address"
                        class="text-sm text-zinc-700/70">Work Address</label
                    >
                    <div class="relative rounded-lg shadow-sm w-full">
                        <div
                            class="pointer-events-none absolute inset-y-0 left-0 flex items-center pl-3"
                ...
                <div class="flex flex-col gap-1 col-span-2">
                    <label
                        for="contact-bg-info"
                        class="text-sm text-zinc-700/70">Background Info</label
                    >
                    <textarea
